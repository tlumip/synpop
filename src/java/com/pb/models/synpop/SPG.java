...
*/
    ...
    public void setupSpg2() {
        ...
        if(hhsByCategoryPath == null) hhsByCategoryPath = (String)spgPropertyMap.get("spg.hhs.by.category.by.zone");

        String laborDollarsByZonePath = (String)spgPropertyMap.get("seam.labor.dollars.by.zone");
        if(laborDollarsByZonePath == null) laborDollarsByZonePath = (String)spgPropertyMap.get("spg.labor.dollars.by.zone");
